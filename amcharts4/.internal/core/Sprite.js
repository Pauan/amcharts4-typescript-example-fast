...
var Sprite = /** @class */ (function (_super) {
    ...
    function Sprite() {
        ...
        /**
         * A read-only flag which indicates if a sprite has completed initial animation (if showOnInit = true). In case showOnInit = false, appeared is set to true on init.
         * @readonly
         * @type {boolean}
         */
 ...
 */
    ...
    Object.defineProperty(Sprite.prototype, "showOnInit", {
         ...
         * If your default state's transitionDuration > 0 this will result initial animation from hidden state properties to default state properties.
        ...
        set: function (value) {
            value = $type.toBoolean(value);
            this.setPropertyValue("showOnInit", value);
            if (value && !this.inited && !this.hidden) {
                registry.events.once("enterframe", this.hideInitially, this);
                this.events.once("beforevalidated", this.hideInitially, this);
                this.events.once("inited", this.appear, this);
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(Sprite.prototype, "hidden", {
        ...
        /**
         * If a sprite has showOnInit = true, the sprite will animate from hidden to default state when initialized. To prevent this but keep showOnInit = true, you can set sprite.hidden = true.
         *
