        ...
        set: function (axis) {
            if (this.axis != axis) {
                this._axis.set(axis, new MultiDisposer([
                    axis.events.on("datavalidated", this.updateValue, this),
                    axis.events.on("datarangechanged", this.updateValue, this),
                    axis.events.on("dataitemsvalidated", this.updateValue, this),
                    axis.events.on("propertychanged", this.invalidate, this)
                ]));
            }
            if (axis) {
